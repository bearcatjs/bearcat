...
/**
 * beanPostProcessor before filter wrap bean if necessary.
 *
...
/**
 * beanPostProcessor after filter wrap bean if necessary.
...
/**
 * create proxy object with specific advisors and targetSource.
 *
 * @param  {Object} bean object
 * @param  {String} beanName
 * @param  {Array}  advisors list
...
/**
 * find all candidate advisors for bean.
 *
 * @param  {Object} bean object
 * @param  {String} beanName
 * @return {Array} advisors list
...
/**
 * find all candidate advisors appliable for bean.
 *
 * @param  {Object} bean object
 * @param  {String} beanName
...
/**
 * check whether an advisor can be applied to the specific bean.
 *
