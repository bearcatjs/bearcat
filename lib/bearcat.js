...
Bearcat.prototype.start = function(cb) {
...
Bearcat.prototype.stop = function() {
...
Bearcat.prototype.getBeanFactory = function() {
	if (this.state !== STATE_STARTED) {
...
Bearcat.prototype.getApplicationContext = function() {
	if (this.state !== STATE_STARTED) {
...
Bearcat.prototype.getBeanByMeta = function(meta) {
	if (this.state !== STATE_STARTED) {
...
Bearcat.prototype.getBean = function(beanName) {
	if (this.state !== STATE_STARTED) {
